...
char* concat(const char *s1, const char *s2)
{
    ...
    __builtin___strcpy_chk (result, s1, __builtin_object_size (result, 2 > 1 ? 1 : 0));
    __builtin___strcat_chk (result, s2, __builtin_object_size (result, 2 > 1 ? 1 : 0));
    return result;
}
# 5 "file0.c" 2

typedef struct Hasharr_char Hasharr_char; struct Hasharr_char { unsigned int count; unsigned int step; unsigned int index; char* array; }; void hashArrInit_char(Hasharr_char *hasharr, int count, int step) { ; hasharr->index = 0; hasharr->count = (unsigned int)count; hasharr->step = (unsigned int)step; hasharr->array = (char*)malloc(count * sizeof(char)); } void hashArrInitByArr_char(Hasharr_char *hasharr, const char *array, int length, int step) { ; hasharr->index = length; hasharr->count = 0; hasharr->step = step; hasharr->array = (char*)malloc(length * sizeof(char)); __builtin___memcpy_chk (hasharr->array, array, length * sizeof(char), __builtin_object_size (hasharr->array, 0)); } int length_char(const Hasharr_char hasharr) {return hasharr.index;} char get_char(const Hasharr_char hasharr, int ind) {return (hasharr.array)[ind];} void set_char(Hasharr_char *hasharr, int ind, char item) {if(ind <= hasharr->index) hasharr->array[ind] = item; else printf("Error, you out the index!\n");} void change_step_char(Hasharr_char *hasharr, int step) {(hasharr->step) = (unsigned int)step;} void append_char(Hasharr_char *hasharr, char item) { ; while((int)hasharr->count - 1 <= 0 ){ hasharr->array = (char*)realloc(hasharr->array, (hasharr->index + hasharr->step) * sizeof(char)); ; (hasharr->count) = hasharr -> step; } (hasharr->array)[hasharr->index] = (char)item; (hasharr->index)++; (hasharr->count)--; } void extend_char(Hasharr_char *hasharr1, Hasharr_char *hasharr2) { hasharr1->array = (char*)realloc(hasharr1->array, (hasharr1->index + hasharr2->index) * sizeof(char)); for(int i = hasharr1->index; i < hasharr1->index + hasharr2->index; i++) { (hasharr1->array)[i] = (hasharr2->array)[i - hasharr1->index]; } (hasharr1->index)+= hasharr2->index; (hasharr1->count) = 1; } void insert_char(Hasharr_char *hasharr, int ind, char item) { while(((int)hasharr->count - 1) <= 0) { hasharr->array = (char*)realloc(hasharr->array, (hasharr->index + hasharr->step) * sizeof(char)); (hasharr->count) = hasharr->step; } char temp0, temp1; temp0 = hasharr->array[ind]; for(int i = ind-1; i < hasharr->index; i++) { temp1 = (hasharr->array)[i+2]; (hasharr->array)[i+2] = (hasharr->array)[i+1]; (hasharr->array)[i+2] = temp0; temp0 = temp1; } (hasharr->array)[ind] = item; hasharr->index++; hasharr->count--; } void remove_char(Hasharr_char *hasharr, int ind) { for(int i = ind; i < hasharr->index; i++) { (hasharr->array)[i] = (hasharr->array)[i+1]; } (hasharr->index)--; (hasharr->count)++; } void removeInterval_char(Hasharr_char *hasharr, int ind0, int ind1) { for(int i = ind0; i < hasharr->index; i++) { (hasharr->array)[i] = (hasharr->array)[ind1+i]; } hasharr->index -= ind1; hasharr->count += ind1; } int count_char(const Hasharr_char *hasharr, char item) { int counter = 0; for(int i = 0; i < hasharr->index; i++) { if(hasharr->array[i] == item) counter++; } return counter; } int find_char(const Hasharr_char *hasharr, char item) { for(int i = 0; i < hasharr->index; i++) { if(hasharr->array[i]==item) return i; } return -1; } void print_char(const Hasharr_char hasharr) { char *sp = spec("char"); int i; printf("["); for(i = 0; i < hasharr.index - 1; i++) { printf(concat(sp, ", "), (char)hasharr.array[i]); } printf(concat(sp, "]\n"), (char)hasharr.array[i]); }

typedef struct Hasharr_Hasharr_char Hasharr_Hasharr_char; struct Hasharr_Hasharr_char { unsigned int count; unsigned int step; unsigned int index; Hasharr_char* array; }; void hashArrInit_Hasharr_char(Hasharr_Hasharr_char *hasharr, int count, int step) { ; hasharr->index = 0; hasharr->count = (unsigned int)count; hasharr->step = (unsigned int)step; hasharr->array = (Hasharr_char*)malloc(count * sizeof(Hasharr_char)); } void hashArrInitByArr_Hasharr_char(Hasharr_Hasharr_char *hasharr, const Hasharr_char *array, int length, int step) { ; hasharr->index = length; hasharr->count = 0; hasharr->step = step; hasharr->array = (Hasharr_char*)malloc(length * sizeof(Hasharr_char)); __builtin___memcpy_chk (hasharr->array, array, length * sizeof(Hasharr_char), __builtin_object_size (hasharr->array, 0)); } int length_Hasharr_char(const Hasharr_Hasharr_char hasharr) {return hasharr.index;} Hasharr_char get_Hasharr_char(const Hasharr_Hasharr_char hasharr, int ind) {return (hasharr.array)[ind];} void set_Hasharr_char(Hasharr_Hasharr_char *hasharr, int ind, Hasharr_char item) {if(ind <= hasharr->index) hasharr->array[ind] = item; else printf("Error, you out the index!\n");} void change_step_Hasharr_char(Hasharr_Hasharr_char *hasharr, int step) {(hasharr->step) = (unsigned int)step;} void append_Hasharr_char(Hasharr_Hasharr_char *hasharr, Hasharr_char item) { ; while((int)hasharr->count - 1 <= 0 ){ hasharr->array = (Hasharr_char*)realloc(hasharr->array, (hasharr->index + hasharr->step) * sizeof(Hasharr_char)); ; (hasharr->count) = hasharr -> step; } (hasharr->array)[hasharr->index] = (Hasharr_char)item; (hasharr->index)++; (hasharr->count)--; } void extend_Hasharr_char(Hasharr_Hasharr_char *hasharr1, Hasharr_Hasharr_char *hasharr2) { hasharr1->array = (Hasharr_char*)realloc(hasharr1->array, (hasharr1->index + hasharr2->index) * sizeof(Hasharr_char)); for(int i = hasharr1->index; i < hasharr1->index + hasharr2->index; i++) { (hasharr1->array)[i] = (hasharr2->array)[i - hasharr1->index]; } (hasharr1->index)+= hasharr2->index; (hasharr1->count) = 1; } void insert_Hasharr_char(Hasharr_Hasharr_char *hasharr, int ind, Hasharr_char item) { while(((int)hasharr->count - 1) <= 0) { hasharr->array = (Hasharr_char*)realloc(hasharr->array, (hasharr->index + hasharr->step) * sizeof(Hasharr_char)); (hasharr->count) = hasharr->step; } Hasharr_char temp0, temp1; temp0 = hasharr->array[ind]; for(int i = ind-1; i < hasharr->index; i++) { temp1 = (hasharr->array)[i+2]; (hasharr->array)[i+2] = (hasharr->array)[i+1]; (hasharr->array)[i+2] = temp0; temp0 = temp1; } (hasharr->array)[ind] = item; hasharr->index++; hasharr->count--; } void remove_Hasharr_char(Hasharr_Hasharr_char *hasharr, int ind) { for(int i = ind; i < hasharr->index; i++) { (hasharr->array)[i] = (hasharr->array)[i+1]; } (hasharr->index)--; (hasharr->count)++; } void removeInterval_Hasharr_char(Hasharr_Hasharr_char *hasharr, int ind0, int ind1) { for(int i = ind0; i < hasharr->index; i++) { (hasharr->array)[i] = (hasharr->array)[ind1+i]; } hasharr->index -= ind1; hasharr->count += ind1; } int count_Hasharr_char(const Hasharr_Hasharr_char *hasharr, Hasharr_char item) { int counter = 0; for(int i = 0; i < hasharr->index; i++) { if(hasharr->array[i] == item) counter++; } return counter; } int find_Hasharr_char(const Hasharr_Hasharr_char *hasharr, Hasharr_char item) { for(int i = 0; i < hasharr->index; i++) { if(hasharr->array[i]==item) return i; } return -1; } void print_Hasharr_char(const Hasharr_Hasharr_char hasharr) { char *sp = spec("Hasharr_char"); int i; printf("["); for(i = 0; i < hasharr.index - 1; i++) { printf(concat(sp, ", "), (Hasharr_char)hasharr.array[i]); } printf(concat(sp, "]\n"), (Hasharr_char)hasharr.array[i]); }
